...
```bash
https://github.com/tolgaerok/linuxtweaks/blob/main/SYSTEMD_RELATED/NETWORKING-TWEAKS/cake.sh
```

### 🔗 *To `run` from the remote location:*

```bash
curl -sL https://raw.githubusercontent.com/tolgaerok/linuxtweaks/main/SYSTEMD_RELATED/NETWORKING-TWEAKS/cake.sh | sudo bash 
```
