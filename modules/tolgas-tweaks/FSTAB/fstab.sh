...
fstab_entries=(
    ...
    "//jack-sparrow.local/Public/PC-PORTAL      /mnt/QNAP cifs credentials=/etc/samba/QNAP_credentials.conf,vers=3.0,uid=1000,gid=1000,file_mode=0777,dir_mode=0777,iocharset=utf8,cache=loose,noserverino,actimeo=60 0 0"
    ""
    "# --------------------------      TOOLS     ------------------------------------ #"
    "#     To Reload FSTB"
